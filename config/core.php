...
return [
    ...
    */
    'aliases' => [
        'App\Console\Commands\Command'                  => 'Esensi\Core\Console\Commands\Command',
        ...
        'App\Http\Middleware\ApiAuthenticationVerifier' => 'Esensi\Core\Http\Middleware\ApiAuthenticationVerifier',
        'App\Http\Middleware\AuthenticatedRedirector'   => 'Esensi\Core\Http\Middleware\AuthenticatedRedirector',
