...
use DateTime;
use Esensi\Core\Traits\Componentable;
...
class FormBuilder
{
     ...
     *
     * @var \Esensi\Core\Extensions\HtmlBuilder
     */
    protected $html;
     ...
     *
     * @param  \Esensi\Core\Extensions\HtmlBuilder        $html
     * @param  \Illuminate\Contracts\Routing\UrlGenerator $url
     * @param  \Illuminate\Contracts\View\Factory         $view
     * @param  string                                     $csrfToken
     * @param  Request                                    $request
     */
    public function __construct(HtmlBuilder $html, UrlGenerator $url, Factory $view, $csrfToken, Request $request)
    {
        $this->url = $url;
        $this->html = $html;
        $this->view = $view;
